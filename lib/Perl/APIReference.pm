...
our $NewestAPI       = '5.018001';
our $NewestStableAPI = '5.018001';
...
=head1 SYNOPSIS
  ...
  my $api = Perl::APIReference->new(perl_version => '5.18.1');
...
Currently, the stable releases perl 5.18.0-1, 5.16.0-3, 5.14.0-3,
