...
our %Perls = (
  ...
  5.016001 => 'V5_016_001',
  5.016    => 'V5_016_000',
# 5.015005 => 'V5_015_005', dropped by S. Randall Sawyer <srandalls@cpan.org> on 09-04-2013
  5.015004 => 'V5_015_004',
# 5.015001 => 'V5_015_001', dropped by S. Randall Sawyer <srandalls@cpan.org> on 09-04-2013
  5.014003 => 'V5_014_003',
  5.014002 => 'V5_014_002',
  5.014001 => 'V5_014_001',
  5.014    => 'V5_014_000',
...
our $NewestAPI       = '5.016002';
our $NewestStableAPI = '5.016002';
...
=head1 SYNOPSIS
  ...
  my $api = Perl::APIReference->new(perl_version => '5.16.2');
...
Currently, the stable releases perl 5.16.0-2, 5.14.0-3,
