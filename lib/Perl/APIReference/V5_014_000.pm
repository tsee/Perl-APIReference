package Perl::APIReference::V5_014_000;
use strict;
use warnings;
...
This is usually handled automatically by C<xsubpp> by calling C<dXSARGS>.
		...
		dITEMS;','name' => 'dITEMS'},'save_scalar' => {'text' => '','name' => 'save_scalar'},'newSUB' => {'text' => '','name' => 'newSUB'},'_to_utf8_fold_flags' => {'text' => '','name' => '_to_utf8_fold_flags'},'despatch_signals' => {'text' => '','name' => 'despatch_signals'},'PUTBACK' => {'text' => 'Closing bracket for XSUB arguments.  This is usually handled by C<xsubpp>.
