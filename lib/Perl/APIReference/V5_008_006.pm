package Perl::APIReference::V5_008_006;
use strict;
use warnings;
...
C<mXPUSHu> and C<XPUSHu>.
	...
	void	mPUSHu(UV uv)','name' => 'mPUSHu'},'call_argv' => {'text' => 'Performs a callback to the specified Perl sub.  See L<perlcall>.
...
if necessary. Handles \'get\' magic.
	...
	void	sv_dec(SV* sv)','name' => 'sv_dec'},'MoveD' => {'text' => 'Like C<Move> but returns dest. Useful for encouraging compilers to tail-call
optimise.

	void *	MoveD(void* src, void* dest, int nitems, type)','name' => 'MoveD'},'SvIOK_only' => {'text' => 'Tells an SV that it is an integer and disables all other OK bits.
