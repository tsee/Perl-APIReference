...
contain SV_GMAGIC, then it does an mg_get() first.
	...
	bool	sv_2bool_flags(SV *sv, I32 flags)','name' => 'sv_2bool_flags'},'malloc' => {'text' => '','name' => 'malloc'},'av_undef' => {'text' => 'Undefines the array.  Frees the memory used by the av to store its list of
...
a newline; the function L</lex_read_to> handles this detail.','name' => 'PL_parser-E<gt>linestart'},'is_safe_syscall' => {'text' => 'Test that the given C<pv> doesn\'t contain any internal NUL characters.
...
C<toUPPER_A> is equivalent.
	...
	U8	toUPPER(U8 ch)','name' => 'toUPPER'},'sv_catpvs_flags' => {'text' => 'Like C<sv_catpvn_flags>, but takes a literal string instead of a
string/length pair.
