package Perl::APIReference::V5_008_007;
use strict;
use warnings;
...
number may use \'_\' characters to separate digits.
	...
	UV	grok_oct(char* start, STRLEN* len, I32* flags, NV *result)','name' => 'grok_oct'},'MARK' => {'text' => 'Stack marker variable for the XSUB.  See C<dMARK>.','name' => 'MARK'},'scan_hex' => {'text' => 'For backwards compatibility. Use C<grok_hex> instead.
